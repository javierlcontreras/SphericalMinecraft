...
public class TerrainManager : MonoBehaviour
{
    ...
    public bool ChunkCloseEnoughToLoad(Vector3 chunkPosition, Vector3 planetPosition) {
        ...
        return (chunkPosition.normalized - radialPosition).magnitude < radiusOfLoad;
    }

    private void Start() {
        
        PlanetGeneratorSettings planetSettings = new PlanetGeneratorSettings("Earth", Vector3.zero, 4, 16, 64);
